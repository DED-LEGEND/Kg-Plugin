...
HelpMenu("admin").add(
    "promote", "<𝗎𝗌𝖾𝗋𝗇𝖺𝗆𝖾/𝗂𝖽/reply> <𝗍𝗂𝗍𝗅𝖾>", "Promote a user to admin.", "promote @DX_LUCKY "
).add(
    "demote", "<username/id/reply>", "Demote a user from admin.", "demote @DX_LUCKY"
).add(
    "ban", "<username/id/reply> <reason>", "Ban a user from the group.", "ban @DX_LUCKY"
).add(
    "unban", "<username/id/reply>", "Unban a user from the group.", "unban @DX_LUCKY"
).add(
    "kick", "<username/id/reply> <reason>", "Kick a user from the group.", "kick @DX_LUCKY"
).add(
    "mute", "<username/id/reply> <reason>", "Mute a user in the group", "mute @DX_LUCKY"
).add(
    "unmute", "<username/id/reply>", "Unmute a user in the group.", "unmute @DX_LUCKY"
).add(
