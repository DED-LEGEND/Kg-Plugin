class First:
    ...
    REPO = """
ʀᴇᴘᴏ [ᴄɪᴄᴋ ʜᴇᴀʀᴇ](https://github.com/DED-LEGEND/DX-PBX_2.0/fork)


 ᴘᴏᴡᴇʀᴇᴅ ʙʏ [⛦⃕͜🇩𝐗🝛꯭••➤‌‌‏🇱𝐔𝐂𝐊𝐘❥︎⃟⛦⃕͜🝛꯭••➤‌‌‏‌](https://t.me/DX_LUCKY)"""
    CREATOR = '[⛦⃕͜🇩𝐗🝛꯭••➤‌‌‏🇱𝐔𝐂𝐊𝐘❥︎⃟⛦⃕͜🝛꯭••➤‌‌‏‌](https://t.me/DX_LUCKY)'
    MSG_ON = """
━━
➠ **𝐔𝐬𝐞𝐫𝐛𝐨𝐭 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 -** `{}`
